...
//             valueKeyUserAfter = 0
//             valueKeyUserBefore = Number(valueKeyUserResult)
//         }
//         NumberOfOperation += 1
//         TypeOperation = Opera
//         NumerOperation.innerHTML += Opera
...
document.body.addEventListener('click' , function (event){
    if (window.innerWidth < 840){
        ...
        // page Y Operation 
        HeightHistoriPhoneMobile = (window.innerHeight - Number(window.getComputedStyle(Calculator).height.slice(0 , -2))) / 2 
        FirsiMapHeightHistori = (Number(window.getComputedStyle(Calculator).height.slice(0 , -2)) - Number(window.getComputedStyle(HistoriPhone).height.slice(0 , -2))) / 2 + HeightHistoriPhoneMobile 
